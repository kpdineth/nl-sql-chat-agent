    ...
    try:
        ...
        response = client.beta.messages.create(
            ...
            system=(
                ...
                "TOOLS AVAILABLE:\n"
                "- Database tools: db_health_check, db_get_customers, db_get_products, db_get_orders, db_run_query, db_get_schema\n"
                "- Code execution: execute_analysis — write Python code with def analyze(rows) to do calculations\n"
                "- Report generation: create_pdf_report (styled PDF), create_html_report (HTML with Chart.js charts)\n"
                "- list_reports: see all generated reports\n\n"
                "When generating reports, the files are saved and accessible via /reports/<filename>. "
